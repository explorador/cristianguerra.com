...
/**
 * NOTE:
 * I tried using <use> to call the same svg animation multiple times in a page
 * BUT performance was terrible (Around 10-25fps vs 33-56fps).
 * To prevent same gradient ID's, I'm just generating random ones PLUS
 * This is the reason why we use React right?
 */
...
export default class Stars extends React.Component {
	...
	render() {
		// Prevent repeated gradients ID's by getting random ones.
		const gradientA = this.getRandomID();
			...
			<StarWrapper aria-hidden="true" className={ this.props.className } position={this.props.position} top={this.props.top} opacity={this.props.opacity}>
				<svg xmlns="http://www.w3.org/2000/svg" width="772" height="511" viewBox="0 0 772 511">
					<defs>
						...
						<linearGradient id={ gradientB } x1="49.972%" x2="49.972%" y1="99.913%" y2="-.087%">
							<stop offset="0%" stopColor="gray" stopOpacity=".25"/>
							<stop offset="54%" stopColor="gray" stopOpacity=".12"/>
							<stop offset="100%" stopColor="gray" stopOpacity=".1"/>
						</linearGradient>
					...
					<g>
						...
						<g ref={ e => this.smallPlanet1 = e } className="small-planet" fillRule="nonzero">
							<path fill={`url(#${ gradientA })`} d="M166.546 464.843c0-6.31 5.111-11.421 11.421-11.421s11.421 5.111 11.421 11.421-5.111 11.421-11.421 11.421-11.421-5.111-11.421-11.421z" opacity=".7"/>
						...
						<g ref={ e => this.mediumPlanet = e } className="medium-planet" fillRule="nonzero">
							<path fill={`url(#${ gradientB })`} d="M563.525 357.708c0-5.304 4.296-9.6 9.6-9.6 5.304 0 9.6 4.296 9.6 9.6 0 5.304-4.296 9.6-9.6 9.6a9.598 9.598 0 0 1-9.6-9.6z" opacity=".7"/>
						...
						<g ref={ e => this.bigPlanet = e } className="big-planet" fillRule="nonzero">
							<path fill={`url(#${ gradientB })`} d="M212.03 308.016a20.11 20.11 0 0 0-5.942-5.266 19.96 19.96 0 0 0-22.91 1.895 20.014 20.014 0 0 0-5.96 22.227A19.98 19.98 0 0 0 196.097 340c.425 0 .833 0 1.266-.042a19.978 19.978 0 0 0 16.813-11.61 20.019 20.019 0 0 0-2.163-20.332h.017z"/>
						...
						<g ref={ e => this.biggestPlanet = e } className="biggest-planet" fillRule="nonzero">
							<path fill={`url(#${ gradientB })`} d="M584.137 152.48a29.25 29.25 0 0 0-8.637-7.602 29.016 29.016 0 0 0-33.14 2.91 28.994 28.994 0 0 0-8.612 32.124A29.008 29.008 0 0 0 560.992 199c.617 0 1.234 0 1.834-.068a29 29 0 0 0 24.527-16.832 28.984 28.984 0 0 0-3.208-29.568l-.008-.05z"/>
